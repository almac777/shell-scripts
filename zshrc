...
alias rt="tput reset && source ~/.zshrc"
alias idea-here="idea . > /dev/null 2> /dev/null &"

# hostname | figlet --gay -f Sub-Zero
hostname | figlet --gay -f Star\ Wars
echo '==='
echo 'Env Variables:'
